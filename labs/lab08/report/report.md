...
Просматриваю содержимое `/var/spool/mail` и убеждаюсь, что письмо появилось (рис. [-@fig:5]). 
...
Аналогичным образом отправляю себе второе письмо через клиент. На адрес `ngalacan@client.ngalacan.net` письмо доставлено (рис. [-@fig:7]), а на `ngalacan@server.ngalacan.net` нет.

![Мониторинг работы почтовой службы через клиент](image/7.png){#fig:7 width=70%}
...
Повторяю отправку письма и проверяю (рис. [-@fig:8]).

![Монторинг работы почтовой службы после изменения конфигурации Postfix](image/8.png){#fig:8 width=70%}
...
Запустив мониторинг работы почтовой службы, вижу, что сообщение не доставлено (рис. [-@fig:9]).

![Мониторинг работы почтовой службы: сообщение не доставлено](image/9.png){#fig:9 width=70%}

Просматриваю очередь на отправление сообщений. Вношу изменения в файл прямой DNS-зоны (рис. [-@fig:10]).

![Изменение файла прямой DNS-зоны ](image/10.png){#fig:10 width=70%}

Вношу изменения в файл обратной DNS-зоны  (рис. [-@fig:11]).

![Изменение файла обратной DNS-зоны ](image/11.png){#fig:11 width=70%}
...
Проверяю отправку почты с клиента на доменный адрес (рис. [-@fig:12])

![Мониторинг работы почтовой службы: сообщение на доменный адрес доставлено](image/12.png){#fig:12 width=70%}
